...
# S2
curl -X POST -d '{"switch":"00:00:00:00:00:00:00:02", "name":"arp-request-s2-src-h2-dst-h3", "eth_type":"0x0806", "arp_opcode":"0x1", "arp_sha":"00:00:00:00:00:02", "active":"true", "actions":"output=3,output=2"}' http://localhost:8080/wm/staticentrypusher/json
